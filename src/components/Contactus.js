...
const Contactus = () => {
  return (
    ...
    <>
      <h1 style={{textAlign:"center", fontSize:"55px", paddingBottom:"5px", color:"white"}} > Get In Touch </h1>

        <div className = "contactBox" id="contactFont">
          
<br/>
    <div  style={{ paddingLeft:"10px"}}></div>
    <Card className="text-center" style={{background:"black"}}>
      {/* <Card.Header>Featured</Card.Header> */}
      <Card.Body>
        <Card.Title>
        </Card.Title>
        <Card.Text>
        <p style={{textAlign:"center", fontSize:"30px", paddingBottom:"10px"}}> Want to work together or have any questions?</p>
        {/* <p style={{textAlign:"center",  fontSize:"20px"}}> You can contact me by emailing me at hafeefas47@gmail.com,</p>
        <p style={{textAlign:"center",  fontSize:"20px"}}> or simply click the button below! </p> */}
        </Card.Text>
        <Button variant="primary" id="contactbutton"> 
        <a href= "mailto:hafeefas47@gmail.com" 
          target="_blank" style={{ textDecoration:"none"}}> 
            <div style={{ color:"white", paddingLeft:"60px", paddingRight:"60px", padding:"20px"}}>
              Email me! 
          </div>
        </a> 
        </Button>
